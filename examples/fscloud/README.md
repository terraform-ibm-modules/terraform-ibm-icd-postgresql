...
- An IAM authorization between all PostgreSQL database instances in the given resource group, and the Key Protect instance that is passed in.
- An IBM Cloud Databases PostgreSQL database instance that is encrypted with the Key Protect root key that is passed in.
...
- You need a Key Protect instance and root key available in the region that you want to deploy your PostgreSQL database instance to.
