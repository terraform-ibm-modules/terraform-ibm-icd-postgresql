...
output "next_steps_text" {
  value       = "Your Database for PostgreSQL Gen2 instance is ready. You can now take advantage of a fully managed service enabling you to efficiently create sophisticated, high-performance applications with enhanced JSON support and improved query parallelism."
