...
| <a name="input_async_restore"></a> [async\_restore](#input\_async\_restore) | Set it to `true`, to initiate the restore as an asynchronous operation, which helps to reduce end-to-end restore time. | `bool` | `false` | no |
