...
| <a name="input_member_enabled"></a> [member\_enabled](#input\_member\_enabled) | This variable is used to conditionally add member\_allocation\_count block depending on requirements | `bool` | `false` | no |
